...
wage_path = r"C:\Users\bryennt\Desktop\gross_living_wage_family.xlsx"
ins_path  = r"C:\Users\bryennt\Desktop\insurance.xlsx"
# 结果输出路径
output_path = r"C:\Users\bryennt\Desktop\net_living_wage_family.xlsx"
# ----------------------------------------------
...
merged["tax"] = merged["gross_living_wage_per"].apply(calc_tax)

# 4. 计算 net_living_wage = gross + tax + insurance
merged["net_living_wage"] = (
    merged["gross_living_wage_per"] + merged["tax"] + merged["insurance"]
)
