...
gdp_growth_rate_clipped = np.clip(gdp_growth_rate, 0, 0.003)
...
# 限定范围
profit_ratio_clipped = np.clip(profit_ratio, 0, 100)
gdp_growth_rate_clipped = np.clip(gdp_growth_rate, 0, 0.02)
